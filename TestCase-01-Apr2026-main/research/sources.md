...
Use this file as the master index for all selected experts and collected materials.
...
## Expert List (Target: 10)

---

### Expert 01 - Justin Welsh
...
- Materials collected:
  - LinkedIn posts: 3 (draft links added; date verification pending)
  - YouTube transcripts: 1 (placeholder source drafted; transcript pending)
  - Other materials: 2 (site + about context)
- Brief annotation (1-2 lines): High-value for top-of-funnel-to-newsletter strategy and message packaging. Search-result URL was replaced with a concrete alternative source until a direct video URL is confirmed.

---

### Expert 04 - Dave Gerhardt
...
- Materials collected:
  - LinkedIn posts: 3 (draft links added; date verification pending)
  - YouTube transcripts: 0 (no verified YouTube video; alternative talk source documented)
  - Other materials: 2 (site + slides)
- Brief annotation (1-2 lines): Strong retention/lifecycle fit; no concrete YouTube video confirmed, so SpeakerDeck talk source is documented as the verified alternative.

---

### Expert 07 - Ethan Smith
...
- Materials collected:
  ...
  - Other materials: 1 (Reforge profile context)
- Brief annotation (1-2 lines): Adds search-to-email acquisition perspective that complements pure email operations experts; direct profile/video URLs are present.

---

### Expert 08 - Brennan Dunn
...
- Materials collected:
  - LinkedIn posts: 3 (draft links added; date verification pending)
  - YouTube transcripts: 0 (no verified YouTube source; alternative reference documented)
  - Other materials: 1 (personalization context page)
- Brief annotation (1-2 lines): Valuable for segmentation/personalization tactics that improve email relevance and revenue; no concrete YouTube source was verified, so alternative evidence is documented.
